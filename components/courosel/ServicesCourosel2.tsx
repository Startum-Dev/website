...
const ServicesCarousel2 = () => {
  return (
    <Carousel
      ...
      className="w-screen"
    >
      <div className="flex grid grid-cols-4 w-full h-96  bg-primary-black">
        <div className="w-full h-full flex flex-col items-start justify-center gap-4 p-4 relative">
          ...
          <div className="absolute flex flex-col gap-4 items-center justify-center hover:bg-transparent-white w-full h-full left-0">
        ...
        <div className="w-full h-full flex flex-col items-start justify-center gap-4 p-4 relative">
          ...
          <div className="absolute flex flex-col gap-4 items-center justify-center hover:bg-transparent-white w-full h-full left-0">
            <p className="font-semibold text-white">
              with our real eastate services you can get a property to buy or
              rent
            </p>
      ...
      <div className="grid grid-cols-4 w-full h-96  bg-primary-black">
        <div className="w-full h-full flex flex-col  items-start justify-center gap-4 p-4 relative ">
