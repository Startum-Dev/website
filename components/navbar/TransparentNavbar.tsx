...
export default function TransparentNavbar(){
    ...
    return(
        <div className="fixed top-0 w-screen  p-4 md:px-64 items-center justify-between flex py-2 h-20 z-10 text-primary-blue">
            ...
            <div className="hidden md:flex w-96 items-center justify-center gap-4">
                ...
                <Link href="#">
                    <text className="text-white text-lg font-semibold">Blog</text>
                </Link>
                <Link href="#">
